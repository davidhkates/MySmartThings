...
preferences {
	...
	section("Garage door") {
    	input "enabled?", "bool", title: "Enabled?", description: "Control door and lights?", required: false
		input "doorSensor", "capability.contactSensor", title: "Which sensor?"
		input "doorSwitch", "capability.momentary", title: "Which switch?"
        input "lightSwitch", "capability.switch", title: "Which lights?", multiple: true
